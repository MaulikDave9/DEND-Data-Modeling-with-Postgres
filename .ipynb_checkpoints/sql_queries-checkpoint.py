...
# Reference: https://knowledge.udacity.com/questions/38635
...
# This knowledge thread was used to debug users table insert - https://knowledge.udacity.com/questions/97651
user_table_insert = ("""
...
#to find the song ID and artist ID based on the title, artist name, and duration of a song: (row.song, row.artist, row.length)
